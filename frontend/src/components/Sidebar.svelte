    ...
    {#each navItems as item}
      ...
      <li class={isSettings ? "mt-auto" : ""}>
        <button
          ...
          class="flex w-full items-center gap-3 border-l-2 px-4 py-3 text-sm transition-colors {currentPage === item.page
            ? 'border-amber-500 bg-neutral-800 text-amber-400'
